                        ...
                        <div class="details_image_thumbnails d-flex flex-row align-items-start justify-content-between">
                            ...
                            @else
                                @foreach($item->images as $img)
                                    @if($loop->first)
                                        <div class="details_image_thumbnail active" data-image="/images/{{$img['name']}}"><img src="/images/{{$img['name']}}" alt="{{$item->title}}"></div>
                                    @else
                                        <div class="details_image_thumbnail" data-image="/images/{{$img['name']}}"><img src="/images/{{$img['name']}}" alt="{{$item->title}}"></div>
                                    @endif
                                @endforeach
                            @endif
                        </div>
